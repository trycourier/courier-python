...
### Added
- Support for [Profiles API](https://docs.courier.com/reference/messages-api) by @jrweingart
  ...
  - `PUT /profiles/{recipient_id}` with `client.profiles.add` and `client.profiles.replace` methods
