...
<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/trycourier.svg?label=pypi%20(stable))](https://pypi.org/project/trycourier/)

The Courier Python library provides convenient access to the Courier REST API from any Python 3.9+
