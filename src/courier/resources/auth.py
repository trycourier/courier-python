...
class AuthResource(SyncAPIResource):
    ...
    def issue_token(
        ...
        *,
        ...
        Args:
          expires_in: Duration for token expiration.

        Accepts various time formats: - "2 hours" - 2
              hours from now - "1d" - 1 day - "10h" - 10 hours - "2.5 hrs" - 2.5 hours -
              "1m" - 1 minute - "5s" - 5 seconds - "1y" - 1 year

          scope: Space-separated list of scopes that define what the token can access. Common
