...
class AutomationsClient:
    ...
    def invoke_automation_template(
        self, template_id: str, *, request: AutomationInvokeParams
    ...
    def invoke_ad_hoc_automation(self, *, request: AutomationAdHocInvokeParams) -> AutomationInvokeResponse:
        """
...
class AsyncAutomationsClient:
    ...
    async def invoke_ad_hoc_automation(self, *, request: AutomationAdHocInvokeParams) -> AutomationInvokeResponse:
        """
        Invoke an ad hoc automation run. This endpoint accepts a JSON payload with a series of automation steps. For information about what steps are available, checkout the ad hoc automation guide [here](https://www.courier.com/docs/automations/steps/).
