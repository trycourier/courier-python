...
from ...types.journeys import run_list_params
from ...types.journey_run_response import JourneyRunResponse
from ...types.journey_run_list_response import JourneyRunListResponse
from ...types.journey_run_steps_response import JourneyRunStepsResponse
...
class RunsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        Returns `404` for an unknown run, a run belonging
        ...
        return self._get(
            path_template("/journeys/runs/{run_id}", run_id=run_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=JourneyRunResponse,
        )
    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          template_id: A comma-separated list of Journey ids to filter on.
        ...
        return self._get(
            ...
            cast_to=JourneyRunListResponse,
        )
    ...
    def list_steps(
        ...
        *,
        ...
        if not run_id:
            raise ValueError(f"Expected a non-empty value for `run_id` but received {run_id!r}")
        return self._get(
            path_template("/journeys/runs/{run_id}/steps", run_id=run_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=JourneyRunStepsResponse,
        )
