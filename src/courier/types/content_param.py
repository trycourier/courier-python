...
class ElementalContentElementType(TypedDict, total=False):
...
_ElementalContentElementUnionMember7ReservedKeywords = TypedDict(
    "_ElementalContentElementUnionMember7ReservedKeywords",
    {
        "if": Optional[str],
    },
    total=False,
...
class ElementalContentElementUnionMember7(_ElementalContentElementUnionMember7ReservedKeywords, total=False):
    channels: Optional[SequenceNotStr[str]]
