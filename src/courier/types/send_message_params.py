...
class MessageToListRecipient(TypedDict, total=False):
    data: Optional[Dict[str, object]]

    list_id: Optional[str]


MessageTo: TypeAlias = Union[UserRecipientParam, MessageToListRecipient, Iterable[RecipientParam]]
