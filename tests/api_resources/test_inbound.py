...
class TestInbound:
    ...
    @parametrize
    def test_method_track_event(self, client: CourierDocs) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_track_event_with_all_params(self, client: CourierDocs) -> None:
        inbound = client.inbound.track_event(
            event="New Order Placed",
            message_id="4c62c457-b329-4bea-9bfc-17bba86c393f",
            properties={
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_track_event(self, client: CourierDocs) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_track_event(self, client: CourierDocs) -> None:
...
class TestAsyncInbound:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_track_event(self, async_client: AsyncCourierDocs) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_track_event_with_all_params(self, async_client: AsyncCourierDocs) -> None:
        inbound = await async_client.inbound.track_event(
            event="New Order Placed",
            message_id="4c62c457-b329-4bea-9bfc-17bba86c393f",
            properties={
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_track_event(self, async_client: AsyncCourierDocs) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_track_event(self, async_client: AsyncCourierDocs) -> None:
