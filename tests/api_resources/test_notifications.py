...
from courier._utils import parse_datetime
...
class TestNotifications:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_get_metrics(self, client: Courier) -> None:
        notification = client.notifications.get_metrics(
            id="x",
        )
        assert_matches_type(NotificationMetricsResponse, notification, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_get_metrics_with_all_params(self, client: Courier) -> None:
        notification = client.notifications.get_metrics(
            id="x",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_get_metrics(self, client: Courier) -> None:
        response = client.notifications.with_raw_response.get_metrics(
            id="x",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_get_metrics(self, client: Courier) -> None:
        with client.notifications.with_streaming_response.get_metrics(
            id="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_get_metrics(self, client: Courier) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.notifications.with_raw_response.get_metrics(
                id="",
            )
...
class TestAsyncNotifications:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_get_metrics(self, async_client: AsyncCourier) -> None:
        notification = await async_client.notifications.get_metrics(
            id="x",
        )
        assert_matches_type(NotificationMetricsResponse, notification, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_get_metrics_with_all_params(self, async_client: AsyncCourier) -> None:
        notification = await async_client.notifications.get_metrics(
            id="x",
            end=parse_datetime("2019-12-27T18:11:19.117Z"),
            granularity="HOUR",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_get_metrics(self, async_client: AsyncCourier) -> None:
        response = await async_client.notifications.with_raw_response.get_metrics(
            id="x",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_get_metrics(self, async_client: AsyncCourier) -> None:
        async with async_client.notifications.with_streaming_response.get_metrics(
            id="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_get_metrics(self, async_client: AsyncCourier) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.notifications.with_raw_response.get_metrics(
                id="",
            )
